    ...
    <section id="contact" className="relative py-24 scroll-mt-24">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <div
            aria-hidden
            className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(circle_at_50%_0%,rgba(124,58,237,0.25),transparent_50%)]"
          />
          <div
            aria-hidden
            className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(circle_at_80%_100%,rgba(59,130,246,0.15),transparent_50%)]"
          />
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.97 }}
              className="glass inline-flex items-center gap-2 rounded-full px-8 py-4 text-sm font-semibold text-foreground cursor-pointer border border-white/10"
            >
          ...
          >
            ...
            >
              <button
                ...
                className="absolute top-5 right-5 flex h-9 w-9 items-center justify-center rounded-full glass cursor-pointer border border-white/10 text-muted hover:text-foreground"
              >
                <X size={16} />
              </button>
              ...
              <form onSubmit={handleSubmit} className="mt-6 space-y-4 text-left">
                <div>
                  ...
                  <input
                    ...
                    className="mt-1.5 w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-foreground placeholder:text-muted/60 outline-none focus:border-neon-cyan/50 transition-colors"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    value={form.service}
                    onChange={handleChange}
                    className="mt-1.5 w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-foreground outline-none focus:border-neon-cyan/50 transition-colors"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="mt-1.5 w-full resize-none rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-foreground placeholder:text-muted/60 outline-none focus:border-neon-cyan/50 transition-colors"
                  />
                </div>
